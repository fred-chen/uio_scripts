...
def parse(path):
    ...
    AVG_READ_LAT_DEV = TOTAL_READ_LAT_DEV / len(data)
    AVG_WRITE_LAT_DEV = TOTAL_WRITE_LAT_DEV / len(data)
    AVG_READ_IOPS_DEV = TOTAL_READ_IOPS_DEV / len(data)
    AVG_WRITE_IOPS_DEV = TOTAL_WRITE_IOPS_DEV / len(data)
    AVG_READ_BW_DEV = TOTAL_READ_BW_DEV / len(data)
    AVG_WRITE_BW_DEV = TOTAL_WRITE_BW_DEV / len(data)
    IOPS_DEVIATION = AVG_READ_IOPS_DEV + AVG_WRITE_IOPS_DEV
